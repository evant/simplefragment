 ...
 * and detaches them from the view hierarchy, and saves and restores their state. The is only one
 * instance of this class per Activity.
 */
public class SimpleFragmentStateManager {
